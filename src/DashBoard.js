...
const DashBoard = () => {
  ...
  let sum_value_pouch = stock.reduce((sum,current)=>{
    ...
    return (
        <>
        <div>
        <h1 className='text-1xl shadow-2xl shadow-red-500 p-6 m-4'>Dashboard- Certificate Stock </h1>
  ...
  <div class="overflow-x-auto">
          <h1 className='text-1xl shadow-2xl shadow-red-500 p-6 m-4'>TOTALL STOCK </h1>
